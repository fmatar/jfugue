...
class ChordGame {
  ...
  public static void main(String[] args) throws MidiUnavailableException {
    MusicTransmitterToParserListener transmitter = new MusicTransmitterToParserListener(
    ...
    for (int i = 0; i < totalGuesses; i++) {
      Chord chord = new Chord(
        rootNames[rnd.nextInt(rootNames.length)] + chordNames[rnd.nextInt(chordNames.length)]);
    ...
    System.out.println("You guessed " + correctGuesses + " chords correctly out of " + totalGuesses
      + " challenges!");
    transmitter.close();
  }
}
...
/**
 * <p>Constructor for ChordGameParserListener.</p>
 */
class ChordGameParserListener extends ParserListenerAdapter {
   ...
   * @return a {@link org.jfugue.examples.book.ChordGameParserListener.GameState} object.
   */
