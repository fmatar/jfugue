...
class MusicTransmitterToSequence {
  ...
  /**
   * <p>Constructor for MusicTransmitterToSequence.</p>
   *
   * @param device a {@link javax.sound.midi.MidiDevice} object.
   */
  public MusicTransmitterToSequence(MidiDevice device) {
    this.device = device;
  ...
  private void startListening() throws MidiUnavailableException, InvalidMidiDataException {
    init();
