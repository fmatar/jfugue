...
/**
 * Represents a device that can receive music that is sent to it. For example, you can connect your
 * external MIDI keyboard, then use this class to send music from your JFugue program to the
 * device.
 *
 * @author fmatar
 * @version $Id: $Id
...
public class MusicReceiver {
  ...
  /**
   * <p>Constructor for MusicReceiver.</p>
   *
   ...
   *
   * @return a {@link javax.sound.midi.Receiver} object.
   */
