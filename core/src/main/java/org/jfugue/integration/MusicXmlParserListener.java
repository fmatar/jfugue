...
public class MusicXmlParserListener implements ParserListener {
  ...
  private final Element root;      //	top-level node of entire MusicXML Document
  ...
  /**
   * <p>Constructor for MusicXmlParserListener.</p>
   */
  public MusicXmlParserListener() {
    ...
    //	may need to add score-parts to this
    Element elPartList = new Element("part-list");
