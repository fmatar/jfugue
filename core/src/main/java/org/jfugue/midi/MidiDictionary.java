...
public class MidiDictionary {
  ...
  /** Constant <code>INSTRUMENT_BYTE_TO_STRING</code> */
  public static final Map<Byte, String> INSTRUMENT_BYTE_TO_STRING = new HashMap<Byte, String>() {{
    put((byte) 0, "Piano");
  ...
  /** Constant <code>INSTRUMENT_STRING_TO_BYTE</code> */
  public static final Map<String, Byte> INSTRUMENT_STRING_TO_BYTE = new HashMap<String, Byte>() {{
    put("PIANO", (byte) 0);
  ...
  /** Constant <code>TEMPO_STRING_TO_INT</code> */
  public static final Map<String, Integer> TEMPO_STRING_TO_INT = new HashMap<String, Integer>() {{
    put("GRAVE", 40);
    put("LARGO", 45);
    put("LARGHETTO", 50);
    put("LENTO", 55);
  ...
  /** Constant <code>TEMPO_INT_TO_STRING</code> */
  ...
  /** Constant <code>CONTROLLER_INT_TO_STRING</code> */
  ...
  /** Constant <code>CONTROLLER_STRING_TO_INT</code> */
