...
/**
 * Returns a List of bytes containing all of the instruments used in the given pattern. This is
 * especially useful for loading instruments from a soundbank, to make sure you only load
 * instruments that are needed by the pattern.
 *
 * @author David Koelle
 * @version 4.0
 */
public class GetInstrumentsUsedTool extends ParserListenerAdapter {
  ...
  private final List<Byte> instruments;

  /**
   * <p>Constructor for GetInstrumentsUsedTool.</p>
   */
  ...
  /**
   * <p>getInstrumentsUsedInPattern.</p>
   *
