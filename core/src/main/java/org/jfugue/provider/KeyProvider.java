...
public interface KeyProvider {
  ...
  /**
   * Creates a key name, like Cmaj, given the root note's position in an octave (e.g., 0 for C) and
   * a major or minor indicator - @see Scale MAJOR_SCALE_INDICATOR and MINOR_SCALE_INDICATOR
   *
  ...
  /**
   * Converts the given Key to a byte value, from -7 for Cb major or Ab major to +7 for C# minor or
   * A# minor, with 0 being C major or A minor
   *
