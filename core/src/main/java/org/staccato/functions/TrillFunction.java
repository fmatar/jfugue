...
/**
 * Replaces the given note with multiple 32nd notes of the given note and the note one interval
 * higher. For example, ":trill(Cq)" will become "Ct Dt Ct Dt Ct Dt Ct Dt"
 *
 * @author dkoelle
 * @version $Id: $Id
 */
public class TrillFunction implements PreprocessorFunction {
   ...
   *
   * @return a {@link org.staccato.functions.TrillFunction} object.
   */
