...
/**
 * <p>PolyPressureFunction class.</p>
 *
 * @author fmatar
 * @version $Id: $Id
 */
public class PolyPressureFunction implements SubparserFunction {
  ...
  private static final String[] NAMES = {"PP", "POLYPRESSURE", "POLY", "POLYPHONIC",
    "POLYPHONICPRESSURE"};
   ...
   *
   * @return a {@link org.staccato.functions.PolyPressureFunction} object.
   */
  ...
  public void apply(String parameters, StaccatoParserContext context) {
    ...
    if (params.length == 2) {
      context.getParser().firePolyphonicPressureParsed(Byte.parseByte(params[0].trim()),
        Byte.parseByte(params[1].trim()));
    }
  }
}
