...
/**
 * Certain functionality of Patterns depend on being able to know what each token parses as. This
 * class provides a bridge between Patterns and Tokens and the StaccatoParser. While the methods
 * below could be a part of either StaccatoParser or Pattern, placing them here helps keep those two
 * classes cleaner.
 *
 * @see StaccatoParser
 * @see Pattern
...
public class StaccatoParserPatternHelper {
  ...
  private final StaccatoParser parser;

  /**
   * <p>Constructor for StaccatoParserPatternHelper.</p>
   */
  ...
  private TokenType getTokenType(String tokenString) {
