...
public class PatternTest {
  ...
  public void testSetTempo1() {
    ...
    assertEquals("T60 A B C", pattern.toString());
  }
  ...
  public void testSetInstrument1() {
    ...
    assertEquals("I[Flute] A B C", pattern.toString());
  }
  ...
  public void testSetInstrument2() {
    ...
    assertEquals("I[French_Horn] A B C", pattern.toString());
  }
  ...
  public void testSetVoice() {
    Pattern pattern = new Pattern("A B C");
    pattern.setVoice(1);
    assertEquals("V1 A B C", pattern.toString());
  }
  ...
  public void testSetTempoInstrumentVoice() {
    ...
    assertEquals("T120 V8 I[Piano] A B C", pattern.toString());
  }
  ...
  public void testAddToNoteElements1() {
    ...
    assertEquals("T60 Aq | Bq V1 Cq", pattern.toString());
  }
  ...
  public void testAddToNoteElements2() {
    ...
    assertEquals("T60 Aq | Bi V1 Cq", pattern.toString());
  }
  ...
  public void testAddToNoteElements3() {
    ...
    assertEquals("T60 Aq | Bi V1 Cs", pattern.toString());
  }
  ...
  public void testAddToNoteElements5() {
    ...
    Pattern pattern = new Pattern("[BASS_DRUM] [HI_HAT] [OPEN_CUICA]").addToEachNoteToken("q i s w")
      .setVoice(9);
    assertEquals("V9 [BASS_DRUM]q [HI_HAT]i [OPEN_CUICA]s", pattern.toString());
  }
  ...
  public void testAddToNoteElements6() {
    ...
    assertEquals("T120 V9 I[PIANO]", pattern.toString());
  }

  @Test
  public void testRepeat() {
    Pattern pattern = new Pattern("A B").repeat(3);
    assertEquals("A B A B A B", pattern.toString());
  }
  ...
  public void testRepeatWithTempoVoiceInstrument1() {
    ...
    assertEquals("T20 V1 A B A B A B", pattern.toString());
  }
  ...
  public void testClear() {
    ...
    assertEquals("C D", pattern.toString());
  }
  ...
  public void testPrependMultiple() {
    ...
    assertEquals("A A B B C C D D", pattern.toString());
  }
}
