...
public class AtomTest {
  ...
  public void testAtom() {
    ...
    assertEquals("&V1,L3,I4,C", atom.toString());
  }

  @Test
  public void testAtomMemberVariables() {
    Atom atom = new Atom((byte) 1, (byte) 3, (byte) 4, "C");
    assertEquals(1, atom.getVoice());
    assertEquals(3, atom.getLayer());
    assertEquals(4, atom.getInstrument());
    assertEquals(atom.getNote(), new Note("C"));
  }

  @Test
  public void testAtomWithContext() {
    Atom atom = new Atom("V1", "L2", "I[Piano]", new Note("C"));
    assertEquals("&V1,L2,I0,C", atom.toString());
  }
  ...
  public void testAtomizePattern() {
    ...
    pattern.atomize();
    assertEquals("&V1,L0,I2,C", pattern.toString());
  }
  ...
  public void testAtomizeCrazierPattern() {
    ...
    pattern.atomize();
    assertEquals(
      "&V1,L0,I0,A &V2,L0,I0,B &V1,L0,I7,C &V3,L7,I0,E &V3,L7,I8,D &V3,L5,I8,C &V3,L5,I4,A &V2,L6,I55,G",
      pattern.toString());
  }
