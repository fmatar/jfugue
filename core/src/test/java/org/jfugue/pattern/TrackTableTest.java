...
public class TrackTableTest {
  ...
  public void testCoolPlacement() {
    ...
    assertEquals(
      "V0 Cmajh Emajh Gmajh Emajh V0  V0 R/1.0 V0 Cmajh Emajh Gmajh Emajh V0  V0 R/1.0 V0 R/1.0 V0 R/1.0 V0 R/1.0 V1 R/1.0 V1 Gq Cq Eq Gq V1 R/1.0 V1 R/1.0 V1 Gq Cq Eq Gq V1 R/1.0 V1 R/1.0 V2 R/1.0 V2 R/1.0 V2 R/1.0 V2 R/1.0 V2 R/1.0 V3 R/1.0 V3 R/1.0 V3 R/1.0 V3 R/1.0 V3 R/1.0 V4 R/1.0 V4 R/1.0 V4 R/1.0 V4 R/1.0 V4 R/1.0 V5 R/1.0 V5 R/1.0 V5 R/1.0 V5 R/1.0 V5 R/1.0 V6 R/1.0 V6 R/1.0 V6 R/1.0 V6 R/1.0 V6 R/1.0 V7 R/1.0 V7 R/1.0 V7 R/1.0 V7 R/1.0 V7 R/1.0 V8 R/1.0 V8 R/1.0 V8 R/1.0 V8 R/1.0 V8 R/1.0 V9 R/1.0 V9 R/1.0 V9 R/1.0 V9 R/1.0 V9 R/1.0 V10 R/1.0 V10 R/1.0 V10 R/1.0 V10 R/1.0 V10 R/1.0 V11 R/1.0 V11 R/1.0 V11 R/1.0 V11 R/1.0 V11 R/1.0 V12 R/1.0 V12 R/1.0 V12 R/1.0 V12 R/1.0 V12 R/1.0 V13 R/1.0 V13 R/1.0 V13 R/1.0 V13 R/1.0 V13 R/1.0 V14 R/1.0 V14 R/1.0 V14 R/1.0 V14 R/1.0 V14 R/1.0 V15 R/1.0 V15 R/1.0 V15 R/1.0 V15 R/1.0 V15 R/1.0",
      t.toString());
  }
  ...
  public void testGetPatternAt() {
    TrackTable t = new TrackTable(5, 1.0d)
      ...
      .setTrackSettings(1, "I[Piano]");
    assertEquals(
      "V0  V1 Gq Cq Eq Gq V2 R/1.0 V3 R/1.0 V4 R/1.0 V5 R/1.0 V6 R/1.0 V7 R/1.0 V8 R/1.0 V9 R/1.0 V10 R/1.0 V11 R/1.0 V12 R/1.0 V13 R/1.0 V14 R/1.0 V15 R/1.0",
      t.getPatternAt(1).toString());
  }
  ...
  public void testPutRhythmInTrack() {
    ...
    TrackTable t = new TrackTable(10, 1.0d);
    t.put(rhythm);
    assertEquals("V9 L0 [ACOUSTIC_SNARE]i Rs [BASS_DRUM]s L1 [HAND_CLAP]i [HAND_CLAP]i",
      t.get(9, 3).toString());
    assertEquals("V9 L0 [ACOUSTIC_SNARE]i Rs [BASS_DRUM]s L1 Rs [HAND_CLAP]s Rs [HAND_CLAP]s",
      t.get(9, 9).toString());
  }
