...
class AudioUtils {
  ...
  public static AudioInputStream getAudioInputStream(Sequence sequence)
    throws MidiUnavailableException, InvalidMidiDataException, IOException {
    return getAudioInputStream(sequence, DEFAULT_PATCH_PROVIDER, DEFAULT_AUDIO_FORMAT,
      DEFAULT_INFO);
  }

  /**
   * Get AudioInputStream from a Sequence. Returns null if there is no available audio synthesizer.
   */
  public static AudioInputStream getAudioInputStream(Sequence sequence, PatchProvider patchProvider,
    AudioFormat format, Map<String, Object> info)
    throws MidiUnavailableException, InvalidMidiDataException, IOException {
...
//        AudioSynthesizer audioSynth = new SoftSynthesizer();
    ...
    long lengthInFrames = (long) (stream.getFormat().getFrameRate() * (
   ...
   */
  @Deprecated
  public static AudioInputStream getAudioInputStream_old(Sequence sequence, AudioFormat format,
    ...
    try {
      stream = (AudioInputStream) openStreamMethod.invoke(synth, new Object[]{format, info});
  ...
  /**
   * TODO: This method is called by getAudioInputStream_old() and is here for debugging purposes
   * only
   */
  @Deprecated
  ...
  /**
   * TODO: Prefer to use MidiTools.sendSequenceToReceiver() - this code is here for debugging
   * purposes only
   */
  @Deprecated
  ...
  /**
   * Attempts to find a Synthesizer capable of producing Audio (e.g., an AudioSynthesizer). Can
   * return null if no synthesizer can be found.
   */
