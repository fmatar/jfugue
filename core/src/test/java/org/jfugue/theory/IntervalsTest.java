...
public class IntervalsTest {
  ...
  public void testNthInterval() {
    ...
    assertEquals("1", intervals.getNthInterval(0));
    assertEquals("3", intervals.getNthInterval(1));
    assertEquals("5", intervals.getNthInterval(2));
  ...
  public void testRotate() {
    Intervals intervals = new Intervals("1 3 5");
    intervals.rotate(1);
    assertEquals("3 5 1", intervals.toString());
  }
