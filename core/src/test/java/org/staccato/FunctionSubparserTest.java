...
public class FunctionSubparserTest extends JFugueTestHelper {
  ...
  public void testPolyPressureSubparser() {
    ...
    assertTrue(
      compare(":POLYPHONICPRESSURE(8,125)", POLYPHONIC_PRESSURE_PARSED, (byte) 8, (byte) 125));
    assertTrue(
      compare(":PolyphonicPressure(8, 125)", POLYPHONIC_PRESSURE_PARSED, (byte) 8, (byte) 125));
  }
  ...
  public void testSysExFunctionSubparser() {
    assertTrue(compare(":SYSEX(7, 120)", new byte[]{(byte) 7, (byte) 120}));
    assertTrue(compare(":SystemExclusive(8,125,70,40)",
      new byte[]{(byte) 8, (byte) 125, (byte) 70, (byte) 40}));
  }
}
