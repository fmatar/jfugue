...
public class BrokenChordPreprocessorTest {
  ...
  private BrokenChordPreprocessor bc;
  ...
  public void testFullChordWithDynamics() {
    assertTrue(bc.preprocess("Fmaj:$0q,$1w,$2h:a40d90", context)
      .equalsIgnoreCase("Fqa40d90 Awa40d90 Cha40d90"));
  ...
  public void testBassWithFirstInversion() {
    assertTrue(
      bc.preprocess("Cmaj^:$BASSq,$0q,$ROOTq,Rq", context).equalsIgnoreCase("Eq Eq Cq Rq"));
  }

  @Test
  public void testBassWithSecondInversion() {
    assertTrue(
      bc.preprocess("Cmaj^^:$BASSq,$0q,$ROOTq,Rq", context).equalsIgnoreCase("Gq Gq Cq Rq"));
  }
  ...
  public void testDictionaryLookup() {
    ...
    assertTrue(bc.preprocess("Cmaj:[MARCH]:a20", context)
      .equalsIgnoreCase("Cqa20 Eqa20+Gqa20 Eqa20+Gqa20 Rqa20"));
  }
