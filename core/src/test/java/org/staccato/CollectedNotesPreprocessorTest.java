...
public class CollectedNotesPreprocessorTest {
  ...
  private CollectedNotesPreprocessor pe;
  ...
  public void testMultipleCollectedNotesInSameString() {
    assertTrue(pe.preprocess("Zi (1+2 3)q Fw (4+5 6)q Zo", context)
      .equalsIgnoreCase("Zi 1q+2q 3q Fw 4q+5q 6q Zo"));
  }

  @Test
  public void testMultipleCollectedNotesInSameStringWithDecimalDuration() {
    assertTrue(pe.preprocess("Zi (1+2 3)/4.0 Fw (4+5 6)/0.5 Zo", context)
      .equalsIgnoreCase("Zi 1/4.0+2/4.0 3/4.0 Fw 4/0.5+5/0.5 6/0.5 Zo"));
  }

  @Test
  public void testNothingAfterParens() {
    assertTrue(pe.preprocess("Zi (1+2 3) Fw (4+5 6) Zo", context)
      .equalsIgnoreCase("Zi (1+2 3) Fw (4+5 6) Zo"));
  }
}
