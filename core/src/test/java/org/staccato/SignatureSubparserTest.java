...
public class SignatureSubparserTest extends JFugueTestHelper {
  ...
  public void testKeySignatureChangesSubsequentNote() {
    assertTrue(
      compare("KEY:Gmaj F5q", new Note(66, 0.25f).setOctaveExplicitlySet(true)));
  }

  @Test
  public void testKeySignatureWithSharpsChangesSubsequentNote1() {
    assertTrue(
      compare("KEY:K#### D5q", new Note(63, 0.25f).setOctaveExplicitlySet(true)));
  }

  @Test
  public void testKeySignatureWithSharpsChangesSubsequentNote2() {
    assertTrue(
      compare("KEY:K# F5q", new Note(66, 0.25f).setOctaveExplicitlySet(true)));
  }

  @Test
  public void testKeySignatureWithFlatsChangesSubsequentNote1() {
    assertTrue(
      compare("KEY:Kb B5q", new Note(70, 0.25f).setOctaveExplicitlySet(true)));
  }

  @Test
  public void testKeySignatureWithFlatsChangesSubsequentNote2() {
    assertTrue(
      compare("KEY:Kbbbb D5q", new Note(61, 0.25f).setOctaveExplicitlySet(true)));
  }
